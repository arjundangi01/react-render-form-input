  ...
  "flex max-w-max flex-1 items-center justify-center",
  {
    ...
    variants: {
      variant: {
        ...
        landingpage: "flex max-w-max flex-1 items-center justify-center",
      },
    },
  }
);
...
>(({ className, children, wrapperclassName, variant, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={cn(navigationMenuVariants({ className, variant }))}
    {...props}
  >
    {children}
    <NavigationMenuViewport wrapperclassName={wrapperclassName} />
  </NavigationMenuPrimitive.Root>
));
